...
if TYPE_CHECKING:
    from fencing import fspawn, OPTIONS_TYPE
...
def get_plug_names(conn: "fspawn", plug_ids: List[int], command_prompt: str, shell_timout: int) -> Dict[int, str]:
    """
...
def get_plug_ids(conn: "fspawn", nodenames: List[str], command_prompt: str, shell_timout: int) -> Dict[str, int]:
    """
...
def get_plug_count(conn: "fspawn", command_prompt: str, shell_timout: int) -> int:
    """
...
def get_plug_status(conn: "fspawn", plug_id: int, command_prompt: str, shell_timout: int) -> FenceEatonPowerActions:
    """
...
def power_on_plug(conn: "fspawn", plug_id: int, command_prompt: str, shell_timout: int, delay: int = 0):
    """
...
def power_off_plug(conn: "fspawn", plug_id: int, command_prompt: str, shell_timout: int, delay: int = 0):
    """
...
def get_power_status(conn: Optional["fspawn"], options: "OPTIONS_TYPE") -> Union[str, NoReturn]:
    """
...
def set_power_status(conn: Optional["fspawn"], options: "OPTIONS_TYPE") -> Optional[NoReturn]:
    """
...
def get_outlet_list(conn: Optional["fspawn"], options: "OPTIONS_TYPE") -> Union[NoReturn, Dict[str, Tuple[str, str]]]:
    """
...
def reboot_cycle(conn: Optional["fspawn"], options: "OPTIONS_TYPE") -> None:
    """
